		...
		<div id="page-wrapper">
	      ...
	      <form action="#" method="post" enctype= "multipart/form-data">
              ...
              <div class="form-group hid1">
                ...
                <input type="text" class="form-control" name="gross_speed" style='text-transform:uppercase' onchange="grade_typing()" value="<?php echo isset($newcerificate)?$newcerificate['gross_speed']:'';?>"   id="gross_speed">
              </div>
              <div class="form-group hid1">
                <label class="text-label">Net Speed</label>
                <input type="text" class="form-control" name="net_speed" style='text-transform:uppercase' onchange="grade_typing()" value="<?php echo isset($newcerificate)?$newcerificate['net_speed']:'';?>"   id="net_speed">
              </div>
               <div class="form-group hid1">
